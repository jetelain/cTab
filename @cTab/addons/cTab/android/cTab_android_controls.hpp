...
#define cTab_GUI_android_MESSAGE_MESSAGELIST_H (cTab_GUI_android_MESSAGE_MESSAGETEXT_FRAME_H - cTab_GUI_android_MESSAGE_MARGIN_INNER * 2 - cTab_GUI_android_MESSAGE_MARGIN_OUTER - cTab_GUI_android_MESSAGE_BUTTON_H)
...
#define cTab_GUI_android_MESSAGE_MESSAGETEXT_H (cTab_GUI_android_MESSAGE_MESSAGELIST_H)
...
#define cTab_GUI_android_MESSAGE_BUTTON_SEND_W (cTab_GUI_android_MESSAGE_MESSAGETEXT_FRAME_W / 5)
#define cTab_GUI_android_MESSAGE_BUTTON_SEND_X (cTab_GUI_android_MESSAGE_COMPOSE_FRAME_X + cTab_GUI_android_MESSAGE_MESSAGETEXT_FRAME_W - cTab_GUI_android_MESSAGE_BUTTON_SEND_W - cTab_GUI_android_MESSAGE_MARGIN_INNER)
...
#define cTab_GUI_android_MESSAGE_BUTTON_DELETE_W cTab_GUI_android_MESSAGE_BUTTON_SEND_W
...
#define cTab_GUI_android_MESSAGE_BUTTON_MODE_W (cTab_GUI_android_MESSAGE_MESSAGELIST_W)
#define cTab_GUI_android_MESSAGE_BUTTON_MODE_X (cTab_GUI_android_MESSAGE_COMPOSE_FRAME_X + cTab_GUI_android_MESSAGE_MARGIN_INNER)
#define cTab_GUI_android_MESSAGE_BUTTON_MODE_Y (cTab_GUI_android_MESSAGE_PLAYERLIST_Y + cTab_GUI_android_MESSAGE_PLAYERLIST_H + cTab_GUI_android_MESSAGE_MARGIN_INNER)
