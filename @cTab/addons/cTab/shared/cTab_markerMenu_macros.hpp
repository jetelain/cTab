...
#define MENU_maxChars 20 // used to determine the necessary width of the menu
...
#define MENU_elementY(item) QUOTE(MENU_elementH * (item - 1))
#define MENU_H(noOfElements) QUOTE((noOfElements + 0.5) * MENU_elementH)
