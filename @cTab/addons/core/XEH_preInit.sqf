...
[QGVAR(microDagrGroupBFT), "CHECKBOX", [LLSTRING(microDagrGroupBFT), LLSTRING(microDagrGroupBFTDetails)], ["cTab", LLSTRING(mapCategory)], false, 0, {}, true] call CBA_fnc_addSetting;
