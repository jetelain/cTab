...
def main():
    ...
    print("""
  #####################################
  # ctab Development Environment Setup #
  #####################################

  This script will create your ctab dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ctab project folder:
    [Arma 3 installation directory]\\{} => ctab project folder
    P:\\{}                              => ctab project folder
