    ...
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            while (true)
            {
                ...
                ExtensionDispatch.RVExtensionRegisterCallback(Callback);
                ExtensionDispatch.RvExtensionArgs("Warmup", new string[0]);
                ExtensionDispatch.RvExtensionArgs("Debug", new string[0]);
                ExtensionDispatch.RvExtensionArgs("Connect", new[] { "\"http://localhost:5000/hub\"", "\"76561198081226363\"", "\"GrueArbre\"", "\"XXXXXX\"" });
                ExtensionDispatch.RvExtensionArgs("StartMission", new[] { "\"Malden\"", "12800", "[2035,6,24,12,0]", "\"3.0\"", "\"3.0\"" });

                ExtensionDispatch.RvExtensionArgs("UpdateMessages", new[] { "[\"12:00 - SP01:1 ([1eGTD] Cpl. J.GrueArbre)\",\"Test\",0,\"m1\"]" });
                ExtensionDispatch.RvExtensionArgs("UpdateMessages", new[] { "[\"12:00 - SP01:1 ([1eGTD] Cpl. J.GrueArbre)\",\"Test\",0,\"m1\"]", "[\"12:00 - SP01:1 ([1eGTD] Cpl. J.GrueArbre)\",\"Test\",2,\"m2\"]" });
                /*ExtensionDispatch.RvExtensionArgs("UpdateMessageTemplates", new[] {
