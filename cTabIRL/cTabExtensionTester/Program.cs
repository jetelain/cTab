...
namespace cTabExtensionTester
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Extension.RvExtensionArgsImpl("StartMission", new[] { "\"Malden\"", "12800", "[2035,6,24,12,0]" });
            ...
            while (true)
            {
                ...
                {
                    Thread.Sleep(250);
                    Extension.RvExtensionArgsImpl("UpdatePosition", new[] { "6093", "9256.31", "171.876", "351.846", "[2035,6,24,12,0]", "\"id1\"" });
                }
